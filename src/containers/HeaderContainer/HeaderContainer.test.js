...
describe('HeaderContainer', () => {
  ...
  test('Check if matches HeaderContainer Snapshot', async () => {
    const route = '/home'
    const tree = rendererWithRouter(<Provider store={store}><IntlProvider locale="en" messages={enUS}><HeaderContainer></HeaderContainer></IntlProvider></Provider>, { route }).toJSON()
