...
describe('HeaderComponent', () => {
  ...
  test('Check if matches HeaderComponent Snapshot', async () => {
    ...
    const tree = rendererWithRouter(<Provider store={store}><IntlProvider locale="en" messages={enUS}><HeaderComponent language={language} switchLanguage={switchLanguagePreference}></HeaderComponent></IntlProvider></Provider>, { route }).toJSON()
