...
describe('ListComponent', () => {
  ...
  test('Check if matches ListComponent Snapshot', async () => {
    const route = '/articles'
    const tree = rendererWithRouter(<Provider store={store}><IntlProvider locale="en" messages={enUS}><ListComponent fetchAllArticles={fetchAllArticlesData} ></ListComponent></IntlProvider></Provider>, { route }).toJSON()
