...
import { isURLSafe, stripHTMLTags } from '../../../utils/xss'
        ...
        <div className="row">
          <div className="col-md-3">
            ...
            <div className="row">
              ...
              <div className={styles.value}>
                <a href={isURLSafe('https://content-eu.goacoustic.com/api/authoring' + (selectedArticle.elements.mainImage.value.leadImage.asset.resourceUri.substring((selectedArticle.elements.mainImage.value.leadImage.asset.resourceUri.indexOf('/v1/')), selectedArticle.elements.mainImage.value.leadImage.asset.resourceUri.length))) ? 'https://content-eu.goacoustic.com/api/authoring' + (selectedArticle.elements.mainImage.value.leadImage.asset.resourceUri.substring((selectedArticle.elements.mainImage.value.leadImage.asset.resourceUri.indexOf('/v1/')), selectedArticle.elements.mainImage.value.leadImage.asset.resourceUri.length)) : null} rel="noopener noreferrer" target="_blank">{selectedArticle.elements.mainImage.value.leadImage.asset.fileName}</a>
              </div>
            </div>
            <div className="row">
                  ...
                  <Tabs>
                    <Tab href="#" id="tab-1" label={intl.formatMessage({ id: 'detailsComponent.default' })} >
                      <div className="some-content">
                        <img alt="default" src={isURLSafe('https://images.unsplash.com/photo-1588702547919-26089e690ecc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80') ? 'https://images.unsplash.com/photo-1588702547919-26089e690ecc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80' : null} />
                      </div>
                    </Tab>
                    <Tab href="#" id="tab-2" label={intl.formatMessage({ id: 'detailsComponent.lead' })} >
                      <div className="some-content">
                        <img alt="lead" src={isURLSafe('https://images.unsplash.com/photo-1588702547919-26089e690ecc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=550&q=80') ? 'https://images.unsplash.com/photo-1588702547919-26089e690ecc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=550&q=80' : null} />
                      </div>
                    </Tab>
                    <Tab href="#" id="tab-3" label={intl.formatMessage({ id: 'detailsComponent.card' })} >
                      <div className="some-content">
                        <img alt="card" src={isURLSafe('https://images.unsplash.com/photo-1588702547919-26089e690ecc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=200&q=80') ? 'https://images.unsplash.com/photo-1588702547919-26089e690ecc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=200&q=80' : null} />
                      </div>
                    </Tab>
                  </Tabs>
                </div>
            ...
            <div className="row">
              ...
              <div className={styles.value}>{
                selectedArticle.elements.body.values.map((paragraphItem, index) => {
                  const temporaryHTMLEntity = document.createElement('p')
                  temporaryHTMLEntity.innerHTML = paragraphItem
                  const extracted = temporaryHTMLEntity.textContent || temporaryHTMLEntity.innerText || ''
                  return (<p key={index} className={styles.textForBodySectionParagraph}>{stripHTMLTags(extracted)}</p>)
                })
              }</div>
            </div>
          </div>
